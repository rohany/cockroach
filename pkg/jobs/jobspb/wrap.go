...
var _ Details = AlterPrimaryKeyDetails{}
...
var _ ProgressDetails = AlterPrimaryKeyProgress{}
...
func DetailsType(d isPayload_Details) Type {
	...
	case *Payload_AlterPrimaryKey:
		return TypeAlterPrimaryKey
	default:
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case AlterPrimaryKeyProgress:
		return &Progress_AlterPrimaryKey{AlterPrimaryKey: &d}
	default:
...
func WrapPayloadDetails(details Details) interface {
	...
	case AlterPrimaryKeyDetails:
		return &Payload_AlterPrimaryKey{AlterPrimaryKey: &d}
	default:
