...
func (Family) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_ea267470cf918009, []int{0}
}
...
func (IntervalDurationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_ea267470cf918009, []int{1}
}
...
func (*T) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_ea267470cf918009, []int{2}
}
...
type InternalType struct {
	...
	TupleContents []T `protobuf:"bytes,8,rep,name=tuple_contents,json=tupleContents" json:"tuple_contents"`
...
func (*InternalType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_ea267470cf918009, []int{3}
}
...
func init() { proto.RegisterFile("sql/types/types.proto", fileDescriptor_types_ea267470cf918009) }

var fileDescriptor_types_ea267470cf918009 = []byte{
	...
	,
}
